...
public:
    ...
    ScopeTable( ScopeTable* p, unsigned long long b)
    {
        ...
        if(p)
        {
            ...
            int p_id=p->get_scope_id_counter();


            int counter= snprintf(nullptr, 0, "%d",p_id);
            //cout<<"p_id  "<<counter;
            ...
            //cout<<;
            // cout<<p->Scope_id;
            snprintf(Scope_id, p_scope_idlen+1+counter+1, "%s.%d", p->Scope_id, p_id );
            //cout<<Scope_id;
            //cout<<Scope_id;
